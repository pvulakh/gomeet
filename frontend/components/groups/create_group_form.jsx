        ...
        <form onSubmit={this.handleSubmit}>
          <div className='create-location'>
            ...
            <div className='create-text'></div>
              ...
              <h5>What's your new GoMeet Group's hometown?</h5>
              <div className='city'>
          ...
          <div className='create-main'>
            ...
            <div className='create-main-text'></div>
              ...
              <h5>What will your GoMeet's name be?</h5>
              ...
              <h5>Describe who should join, and what your GoMeet will do.</h5>
          ...
          <div className='create-disclaimer'>
            ...
            <div className='create-disc-text'></div>
              ...
              <h5>What it means to be a GoMeet</h5>
              <ul>
